...
public:
    ...
    double calculateDemandFromCost(int day, int client, double detour, double cost, double freeload, int depotIdx = -1);
    void clear();
    ...
    double calculateCost(int day, int client, double detour, double demand, double freeload, int depotIdx = -1);
    double calculateCost_stockout(int day, int client, double detour, double replenishment, double freeload, int depotIdx = -1); 
    double calculateCost_holding(int day, int client, double detour, double replenishment, double freeload, int depotIdx = -1); 
